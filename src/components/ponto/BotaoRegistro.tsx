...
export function BotaoRegistro({ proximoTipo, diaNaoTrabalhado, registrando, desabilitado, onRegistrar }: BotaoRegistroProps) {
  ...
  if (diaNaoTrabalhado) {
    return (
      <div className="rounded-card border border-surface-border bg-white px-6 py-8 text-center shadow-sm">
  ...
  if (!proximoTipo) {
    return (
      <div className="flex flex-col items-center gap-2 rounded-card border border-green-600/20 bg-green-100 px-6 py-8 text-center shadow-sm">
