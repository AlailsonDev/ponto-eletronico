...
export function MapaLocalizacao({ usuario, trabalho, raioMetros, valida }: { usuario: Coordenadas; trabalho: Coordenadas; raioMetros: number; valida: boolean }) {
  return (
    <MapContainer center={[trabalho.latitude, trabalho.longitude]} zoom={17} scrollWheelZoom={false} className="relative z-0 isolate h-64 w-full rounded-card shadow-sm">
